...
function cards() {
  ...
  var MenuCards = /*#__PURE__*/function () {
    function MenuCards(src, alt, title, descr, price, parentSelector) {
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (e) {
      ...
      // })
      (0,_services_services__WEBPACK_IMPORTED_MODULE_10__.postData)("http://localhost:3000/requests", json)
      // .then(data => data.text())
      .then(function (data) {
        console.log(data);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2023-05-26');
});
})();
